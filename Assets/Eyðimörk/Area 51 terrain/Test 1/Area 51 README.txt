...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Area+51&box=-116.019676,37.623672,-116.700185,37.084689
...
-----------
  ...
  * Area 51 Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Area 51 Height Map (SRTM3 v4.1).png
  ...
  * Area 51 Height Map (SRTM30 Plus).png
  ...
  * Area 51 Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 1213m (actual) is equal to 40m in
